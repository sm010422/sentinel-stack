...
│  │                                                             │    │
│  │  ┌──────────┐  ┌──────────┐  ┌──────────┐  ┌──────────┐   │    │
│  │  │ capture  │→ │  parser  │→ │rule_eng  │→ │ reporter │   │    │
│  │  │ libpcap  │  │ETH/IP/   │  │ 이상탐지 │  │CSV/TUI  │   │    │
│  │  │ 무차별모드│  │TCP/UDP   │  │슬라이딩  │  │통계집계 │   │    │
│  │  │          │  │sentinel  │  │윈도우    │  │         │   │    │
│  │  └──────────┘  └──────────┘  └──────────┘  └──────────┘   │    │
│  └──────────────────────┬────────────────────────────────────┘    │
│                         │ 모니터링 (lo0/eth0)                       │
...
│  │                                                             │    │
│  │  ┌──────────┐  ┌──────────┐  ┌──────────┐  ┌──────────┐   │    │
│  │  │ TCP 9000 │  │ UDP 9001 │  │ PubSub  │  │AES-256  │   │    │
│  │  │ 신뢰채널 │  │ 고속채널 │  │ 토픽기반 │  │  GCM   │   │    │
│  │  │epoll/    │  │멀티캐스트│  │라우팅   │  │암호화  │   │    │
│  │  │kqueue    │  │         │  │         │  │        │   │    │
│  │  └──────────┘  └──────────┘  └──────────┘  └──────────┘   │    │
...
│  │                                                             │    │
│  │  ┌──────────┐  ┌──────────┐  ┌──────────┐  ┌──────────┐   │    │
│  │  │  RMS     │  │  EDF     │  │Mutex/   │  │  Jitter  │   │    │
│  │  │Rate      │  │Earliest  │  │Sema/   │  │측정/통계│   │    │
│  │  │Monotonic │  │Deadline  │  │MsgQueue│  │WCET추적 │   │    │
│  │  │선점 스케줄│  │First     │  │(정적풀) │  │         │   │    │
│  │  └──────────┘  └──────────┘  └──────────┘  └──────────┘   │    │
│  └──────────────────────────────────────────────────────────┘    │
│                                                                      │
│  Target: Linux ARM / macOS BSD  |  검증: QEMU Cortex-M3             │
└──────────────────────────────────────────────────────────────────────┘
```
